...
def main():
    ...
    try:
        while True:
            ...
            labeled_front = add_camera_label(frame_front, " FRONT CAMERA (กล้องหน้า)", color_bg=(0, 160, 0))     # สีเขียว
            labeled_back  = add_camera_label(frame_back,  " BACK CAMERA (กล้องหลัง)",   color_bg=(160, 0, 0))     # สีน้ำเงิน
            labeled_left  = add_camera_label(frame_left,  " LEFT CAMERA (กล้องซ้าย)",   color_bg=(0, 140, 200))   # สีส้ม
            labeled_right = add_camera_label(frame_right, " RIGHT CAMERA (กล้องขวา)",  color_bg=(160, 0, 160))   # สีม่วง
