...
cd "C:\Users\Jirapat Chumaungphan\Documents\Quanser\QCar2\Linux\Physical\Simulink"
...
:: start "" ssh nvidia@192.168.2.56 "cd ~/Documents ; python yolov8_client_img_stream.py"
...
quarc_run -D -r -t tcpip://localhost:17000 Simulink\QCar2_Virtual_Car1.rt-win64 -virtual_only 0 -physical_uri tcpip://192.168.2.56:777
...
python resources_qlab_setup/Traffic_Controller.py -ip 192.168.2.56